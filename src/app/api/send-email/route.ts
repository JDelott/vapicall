  ...
  try {
    ...
    const emailHtml = `
      ...
      <html>
        <head>
          <meta charset="utf-8">
          <title>VAYA Call - Conversation Summary</title>
          <style>
        ...
        <body>
          <div class="header">
            <h1>VAYA Call Conversation Summary</h1>
          ...
          <div class="footer">
            <p>This email was generated by VAYA Call - AI Voice Assistant Platform</p>
    ...
    const emailText = `
VAYA Call Conversation Summary
...
---
This email was generated by VAYA Call - AI Voice Assistant Platform
    `;

    // Send email using Resend
    const { data, error } = await resend.emails.send({
      from: 'VAYA Call <noreply@vayacall.com>',
      to: [email],
      subject: `VAYA Call Conversation Summary - ${currentDate}`,
      html: emailHtml,
      text: emailText,
    });
